...
int main(int argc, char *argv[]) {
    ...
    start = std::chrono::high_resolution_clock::now();
    std::pair<std::vector<int>, int> new_img_tbb = MarkComponentsParTbb(&array_tbb, img.rows, img.cols, 1);
    end = std::chrono::high_resolution_clock::now();
    diff = end - start;
    ...
    start = std::chrono::high_resolution_clock::now();
    std::pair<std::vector<int>, int> new_img_std = MarkComponentsParStd(&array_omp, img.rows, img.cols, 1);
    end = std::chrono::high_resolution_clock::now();
    diff = end - start;
